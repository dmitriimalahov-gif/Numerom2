...
# Инициализация уроков V2 - используйте админ панель для загрузки уроков
echo "ℹ️  Система обучения V2 готова"
echo "💡 Используйте админ панель для загрузки уроков из файлов"
