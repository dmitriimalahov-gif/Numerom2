...
class LessonSystem:
    ...
    def initialize_first_lesson(self):
        ...
        first_lesson = Lesson(
            ...
            title="Введение в NumerOM: История космического корабля и основы нумерологии",
            module="Модуль 1: Основы",
            content={
                "theory": {
                    "what_is_numerology": """
                    Нумерология - это древняя наука о влиянии чисел на судьбу и характер человека.
                    В ведической традиции числа связаны с планетарными энергиями (Граха), 
                    которые формируют наши качества, таланты и жизненные вызовы.
                    """,
                    
                    "cosmic_ship_story": """
                    История космического корабля помогает понять, как энергии чисел работают в команде:
                    
                    🌟 СОЛНЦЕ (1) - Создатель идеи корабля, лидер экспедиции, вдохновляет команду
                    🌙 ЛУНА (2) - Отвечает за уют, эмоциональный климат, взаимоотношения
                    🪐 ЮПИТЕР (3) - Технологии, образование, мудрость, банковская система
                    🌀 РАХУ (4) - Революционные изменения, ИИ, роботы, трансформация
                    ☿️ МЕРКУРИЙ (5) - Связь с другими мирами, языки, расширение
                    ♀️ ВЕНЕРА (6) - Красота корабля, развлечения, искусство, комфорт
                    🔮 КЕТУ (7) - Духовность, интуиция, магия, отрешенность от материального
                    🪐 САТУРН (8) - Порядок, правила, контроль, дисциплина
                    ⚔️ МАРС (9) - Защита, справедливость, спорт, военная стратегия
                    ⭕ АНУГРАХА (0) - Потенциал для развития или разрушения
                    """,
                    
                    "planets_and_numbers": """
                    Соответствие планет и чисел:
                    1 = Сурья (Солнце) - лидерство, эго, отец
                    2 = Чандра (Луна) - эмоции, мать, интуиция  
                    3 = Гуру (Юпитер) - мудрость, учитель, знания
                    4 = Раху - иллюзии, материальность, амбиции
                    5 = Будха (Меркурий) - интеллект, коммуникация
                    6 = Шукра (Венера) - любовь, красота, роскошь
                    7 = Кету - духовность, мистика, прошлое
                    8 = Шани (Сатурн) - карма, препятствия, дисциплина
                    9 = Мангала (Марс) - энергия, конфликты, сила
                    """,
                    
                    "three_states": """
                    Каждая планета может находиться в трех состояниях (Гуны):
                    
                    🔴 РАДЖАС - активность, страсть, действие
                    🔵 САТТВА - гармония, мудрость, баланс  
                    ⚫ ТАМАС - инертность, лень, разрушение
                    
                    Цель нумерологии - научиться балансировать энергии планет
                    и переводить их в состояние Саттвы для гармоничной жизни.
                    """
                },
