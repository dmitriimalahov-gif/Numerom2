...
чтобы они соответствовали реальным именам файлов из v0 версии.
"""
...
async def fix_file_names():
    ...
    # Подключение к MongoDB через Docker
    client = AsyncIOMotorClient("mongodb://localhost:27018")
    db = client.numerom

    # Папка с файлами
    uploads_dir = Path("/Users/brandbox/Desktop/numerom/Numerom1/backend/uploads/learning_v2")
        ...
        if potential_path.exists():
            ...
            if potential_path.exists():
                ...
                for file_path in uploads_dir.glob("*"):
                    if file_path.is_file() and original_name in file_path.name:
