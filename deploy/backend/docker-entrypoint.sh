...
# Инициализация уроков отключена - используем ручное создание через скрипты
echo "ℹ️  Автоматическая инициализация уроков отключена"
echo "💡 Используйте скрипты create_lesson_*.py для создания уроков"
